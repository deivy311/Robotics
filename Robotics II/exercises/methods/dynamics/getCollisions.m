...
if(~isempty(z.collides))
    ...
    for icollides=1:num_coll
        ...
        if(movingframes)
            ...
            vc_collisions=[vc_collisions,J_c_collisions{icollides}*q_dot];
...
% isMotor=false
[zout.C,zout.cac,zout.Csubs,zout.S] = getCs(M,q,q_dot);
[zout.g_q, zout.PE, zout.U,zout.g_q_short,zout.PE_short] = getGravityWithPc(Pc, q, l, m, dc, z.g, z.isMotor)
