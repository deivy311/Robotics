function [KE, T] = getKEwithJacobianTrans(TPartial, sigma, q, qd, l, m, I, d, isMotor, qdm)
...
for i = 1:n
    ...
    [Jp, Jo] =  getJacobianFromA(TPartial,sigma,i);
    % Get rotation matrix
...
%         0.5*qd_(1:i).'*Jo.'*R*I(i)*R.'*Jo*qd_(1:i));
    T{i} = simplify(0.5*(m(i))*qd_.'*Jp.'*Jp*qd_ + ...
        0.5*qd_.'*Jo.'*R*I(i)*R.'*Jo*qd_);
